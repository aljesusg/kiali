= SWS image:https://travis-ci.org/jmazzitelli/sws.svg["Build Status", link="https://travis-ci.org/jmazzitelli/sws"] image:https://goreportcard.com/badge/github.com/swift-sunshine/swscore["Go Report Card", link="https://goreportcard.com/report/github.com/swift-sunshine/swscore"]
:toc: macro
:toc-title:
